 ...
 * @Desc
 */
object GbtPiplineSDAI {
  def main(args: Array[String]): Unit = {
    val conf = new SparkConf().setAppName("GbtPiplineSDAI")
    /*.setMaster("local[*]")*/
    ...
    val fi=model.stages(2).asInstanceOf[GBTClassificationModel].featureImportances.toArray
